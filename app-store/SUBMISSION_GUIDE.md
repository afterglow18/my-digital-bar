# App Store Submission Guide — My Digital Bar
...
3. Fill in:
   ...
   - Bundle ID: **com.mydigitalbar.app** *(you'll need to register this in your Developer account first)*
...
3. Bundle ID: `com.mydigitalbar.app`
...
- [ ] In-App Purchase created in App Store Connect (Product ID: `com.mydigitalbar.app.premium`)
...
→ Register `com.mydigitalbar.app` in your Apple Developer account (Step 3)

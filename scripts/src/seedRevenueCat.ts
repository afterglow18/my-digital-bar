...
const PROJECT_NAME        = "My Digital Bar";
const APP_STORE_APP_NAME  = "My Digital Bar";
const APP_STORE_BUNDLE_ID = "com.mydigitalbar.app";
...
const PRODUCTS: ProductDef[] = [
  {
    ...
    displayName: "Monthly – My Digital Bar",
    type:        "subscription",
    duration:    "P1M",
  ...
  },
  {
    ...
    displayName: "Yearly – My Digital Bar",
    type:        "subscription",
    duration:    "P1Y",
  ...
  },
  {
    ...
    displayName: "Lifetime – My Digital Bar",
    type:        "non_consumable",

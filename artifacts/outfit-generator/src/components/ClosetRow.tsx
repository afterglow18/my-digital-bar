...
const BG_CENTER   = "rgba(212,180,140,0.88)";   // tan card for selected item
const SHADOW_CTR  = "0 0 8px rgba(232,199,90,0.60), 0 0 20px rgba(232,199,90,0.30)";
        ...
        >
          {items.slice(lo, hi + 1).map((item, localIdx) => {
            ...
            if (transitioning) {
              ...
              bg      = `rgba(212,180,140,${(p * 0.88).toFixed(3)})`;
              shadow  = p > 0.05
                ? `0 0 ${(8 * p).toFixed(1)}px rgba(232,199,90,${(0.6 * p).toFixed(3)}), 0 0 ${(20 * p).toFixed(1)}px rgba(232,199,90,${(0.3 * p).toFixed(3)})`
                : "none";
            }

/**
 * WardrobePage — bar-shelves-bg.png (1024×1536 PNG)
 *
...
const ROWS: { key: RowKey; btnLabel: string }[] = [
  { key: "outfits",    btnLabel: "+ ADD COCKTAILS" },
  { key: "beauty",     btnLabel: "+ ADD SPIRITS"   },
  { key: "toiletries", btnLabel: "+ ADD MIXERS"    },
        ...
        <>
          ...
          {itemsLeft !== null && (
            <button
              ...
              style={{
                position: "absolute",
                bottom: 170, left: "50%", transform: "translateX(-50%)",
                zIndex: 25,
                ...
                color: totalItems >= FREE_ITEM_LIMIT ? "#aa0000" : "#ffffff",

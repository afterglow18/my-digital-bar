          ...
          <>
            ...
            {ROWS.map(({ key }, rowIdx) => {
              ...
              const SHELF_LABELS: Record<string, string> = {
                outfits: "DRINKS", beauty: "MIXERS & GARNISHES",
                toiletries: "GLASSWARE", essentials: "BAR TOOLS",
              };
            ...
            {!hasItems && (
              <div style={{
                ...
                <p style={{
                  ...
                  Add drinks, mixers & garnishes, glassware or bar tools in the Bar tab first.
                </p>
              </div>
            )}
